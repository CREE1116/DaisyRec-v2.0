...
class STARS_exp(GeneralRecommender):
    """
    ...
    def __init__(self, config):
        ...
        """
        super(STARS_exp, self).__init__(config)
    ...
    def _get_topic_profile(self, embeddings):
        ...
        logits = torch.einsum('...d,kd->...k', embeddings, self.global_topic_keys) * self.scale
        profile = torch.exp(logits)
        return profile
